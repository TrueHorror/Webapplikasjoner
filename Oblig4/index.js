...
try {
  ...
  /// Destructuring ///
	...
	(function UseArrayDestructuring1() {
		...
		let [a,,b, ...c] = arr;
		//let {a = arr[0], b = arr[2], c = arr.slice(3)} = arr;
  ...
  /// class (bonus) ///
	...
	(function UseClass() {
		...
		let Multiplier = class {
			constructor(x){
				this.multiplierNum = x;
			}

			//method
			multiply(y){
				return y * this.multiplierNum;
			}
		};
  ...
  /// Template strings (bonus) ///
	...
	(function UseTemplateStrings2() {
		...
		const line1 = 'line 1'
		const line2 = 'line 2'
		const text = `${line1}\n${line2}`; // Prøvde å sette de på 2 linjer, men fikk fortsatt feil...
